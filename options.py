...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='./models/AUWTAL')
    parser.add_argument('--output_path', type=str, default='./outputs/AUWTAL')
    parser.add_argument('--log_path', type=str, default='./logs/AUWTAL')
